...
public class A22ForReview {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("문제2) %d부터 %d까지의 더하기 : %d", m, n, sum));
        ...
        System.out.println(String.format("4) 시작값 정수 m부터 마지막 값 n까지 곱하기 : %d", m, n, result));
        ...
        System.out.println(String.format("5) 2의 n의 제곱 구하기 : 2를 %d번 곱하기 : %,d",  n, longResult));
        //1) 1부터 정수 n 까지 더하기
        //2) 1부터 정수 n 까지 곱하기
